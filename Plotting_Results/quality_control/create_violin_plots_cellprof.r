...
names(ext_meta)[names(ext_meta)=="broad_sample"]<-"Metadata_broad_sample"
datafile=merge(ext_meta,datafile,by="Metadata_Well")
...
ggsave(paste0(filetype,"_","violin_plot.png"), type = "cairo")